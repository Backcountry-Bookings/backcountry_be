...
RSpec.describe 'CampsitesSearch API' do
  before :each do
    ...
    stub_request(:get, "https://developer.nps.gov/api/v1/campgrounds?api_key=#{ENV['NPS_API_KEY']}&lat=37.7749&long=-122.4194")
      .to_return(status: 200, body: File.read('./spec/fixtures/campsites_search_by_location.json'), headers: {})
  end
  ...
  describe '#get_campsites_by_location' do
    it 'returns the campsites by location' do
      get '/api/v1/campsites?lat=37.7749&long=-122.4194'
